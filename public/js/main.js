//Este evento se ejecuta cuando se carge totalmente tu ventana(DOM)
...
/**submit: Uno de los usos más extendidos es la de validar los datos ingresados al formulario y abortar el envío de los mismos al servidor (con esto liberamos sobrecargas del servidor) */
document.querySelector('#formulario').addEventListener('submit', (e)=>{//El evento submit se da al enviar el formulario
    e.preventDefault();//Omite el evento de cargar la paigna el preventdefault
